---
title: Kubernetes 服务暴露方式：NodePort, LoadBalancer 与 Ingress
description: 详细对比 Kubernetes 集群外访问 Service 的几种主流方式：HostNetwork, NodePort, LoadBalancer 及 Ingress。
keywords: K8s 服务暴露, Ingress, NodePort, LoadBalancer, 外部访问
---
