---
title: Kubernetes Service 通信机制与 IPVS 模式
description: 探讨 K8s Service 间的通信原理，重点解析 kube-proxy 的 IPVS 模式及其相对于 iptables 的优势。
keywords: K8s Service, IPVS, kube-proxy, 服务发现, 负载均衡
---
