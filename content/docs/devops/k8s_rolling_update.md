---
title: Kubernetes 滚动更新 (Rolling Update) 原理与 502 问题排查
description: 深入分析 K8s 滚动升级过程中的 Pod 状态变化、流量切换及优雅停机策略，解决升级时的 502 报错。
keywords: K8s 滚动更新, RollingUpdate, 优雅停机, 502 错误, 服务发布
---
