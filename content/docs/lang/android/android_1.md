---
title: Android 基础概念与核心架构
description: 涵盖 Android 资源目录 (drawable/mipmap)、Window 窗口管理以及 Gradle 预定义变量的深度解析。
keywords: Android 基础, WindowManager, Gradle 配置, 资源管理, Android 开发
---
# 目录
- [目录](#目录)
- [Android](#android)
