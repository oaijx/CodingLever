---
title: Android Gradle 构建系统高级配置与优化
description: 详细讲解 Android Gradle Plugin 的使用，包括自定义任务、插件开发、构建速度优化及依赖管理。
keywords: Android Gradle, 构建优化, Gradle 插件, Groovy, Kotlin DSL
---
# 目录
- [目录](#目录)
